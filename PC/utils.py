...
def get_fer2013_images():
    ...
    save_image_from_fer2013('../dataset/fer2013/fer2013.csv')
...
def get_jaffe_images():
    ...
    for file in files:
        ...
        index += 1
    if not os.path.exists('../dataset/jaffe/Training'):
        os.mkdir('../dataset/jaffe/Training')
...
def cv2_img_add_text(img, text, left, top, text_color=(0, 255, 0), text_size=40):
    """
    :param img:
    :param text:
    :param left:
    ...
    font_text = ImageFont.truetype(
        "C:\Windows\Fonts\simhei.ttf", text_size, encoding="utf-8")  # 使用宋体
